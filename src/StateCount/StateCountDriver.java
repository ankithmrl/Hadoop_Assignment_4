...
import StateCount.StateCountDriver;
...
public class StateCountDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		if (args.length != 2) {
	        System.err.println("Usage: StateCountDriver <input path> <output path>");
	        System.exit(-1);
	      }
		
		//Job Related Configurations
	  	Configuration conf = new Configuration();
	  	Job job = new Job(conf, "Total Units sold in each State for Onida Company");
	    ...
	    job.setMapperClass(StateCount.StateCountMapper.class);
	    job.setReducerClass(StateCount.StateCountReducer.class);
